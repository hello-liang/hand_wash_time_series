...
common_pose_dataset_path = '/home/liang/datasets/common_pose/'
common_pose_dataset_path_dest = './datasets/common_pose/'
base_dataset = '/home/liang/datasets/HandGestureDataset_SHREC2017/'
...
for split_mode in ['train', 'val']:
    ...
    for ann in anns:
        ...
        if not os.path.exists(os.path.join(common_pose_dataset_path, 'SHREC2017')):
            os.makedirs(os.path.join(common_pose_dataset_path, 'SHREC2017'))
