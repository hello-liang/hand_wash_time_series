...
base_dataset = '/home/liang/datasets/F-PHAB/'
...
for split_mode, anns in [('train', anns_train), ('val', anns_val)]:
    ...
    for ann in anns:
        ...
        if not os.path.exists(os.path.join(common_pose_dataset_path, 'F-PHAB')):
            os.makedirs(os.path.join(common_pose_dataset_path, 'F-PHAB'))
